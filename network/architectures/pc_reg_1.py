...
class PCNet(nn.Module):
    ''' Performs regression on the principal components of the trajectory. '''
    def __init__(self, n_past_lidars, n_past_steps, n_future_steps, n_pc):
        ...
        # The output layer forms the principal component values
        self.linear_d4 = nn.Linear(256, n_pc)
