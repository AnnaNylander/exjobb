...
class CNNBiasAll(nn.Module):
    ...
    def __init__(self, n_past_lidars, n_past_steps, n_future_steps):
        ...
        self.conv_c5 = nn.Conv2d(96,96,3, padding=(16,16), dilation=(16,16))
        self.bias_c5 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c6 = nn.Conv2d(96,96,3, padding=(32,32), dilation=(32,32))
        self.bias_c6 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c7 = nn.Conv2d(96,96,3, padding=(2,2), dilation=(2,2))
        self.bias_c7 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c8 = nn.Conv2d(96,96,3, padding=(4,4), dilation=(4,4))
        self.bias_c8 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c9 = nn.Conv2d(96,96,3, padding=(8,8), dilation=(8,8))
        self.bias_c9 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c10 = nn.Conv2d(96,96,3, padding=(16,16), dilation=(16,16))
        self.bias_c10 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c11 = nn.Conv2d(96,96,3, padding=(32,32), dilation=(32,32))
