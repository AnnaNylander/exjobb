...
class CNNBiasAll(nn.Module):
    ...
    def __init__(self, n_past_lidars, n_past_steps, n_future_steps):
        ...
        # new
        self.conv_c2 = nn.Conv2d(96,96,3, padding=1)
        self.bias_c2 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c3 = nn.Conv2d(96,96,3, padding=(2,1), dilation=(2,1))
        self.bias_c3 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c4 = nn.Conv2d(96,96,3, padding=(4,2), dilation=(4,2))
        self.bias_c4 = nn.Linear(self.vs, 96 ) # 330 x 8

        # new
        self.conv_c5 = nn.Conv2d(96,96,3, padding=1)
        self.bias_c5 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c6 = nn.Conv2d(96,96,3, padding=(8,4), dilation=(8,4))
        self.bias_c6 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c7 = nn.Conv2d(96,96,3, padding=(12,8), dilation=(12,8))
        self.bias_c7 = nn.Linear(self.vs, 96 ) # 330 x 8

        # new
        self.conv_c8 = nn.Conv2d(96,96,3, padding=1)
        self.bias_c8 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c9 = nn.Conv2d(96,96,3, padding=(16,12), dilation=(16,12))
        self.bias_c9 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c10 = nn.Conv2d(96,96,3, padding=(20,16), dilation=(20,16))
        self.bias_c10 = nn.Linear(self.vs, 96 ) # 330 x 8

        # new
        self.conv_c11 = nn.Conv2d(96,96,3, padding=1)
        self.bias_c11 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c12 = nn.Conv2d(96,96,3, padding=(24,20), dilation=(24,20))
        self.bias_c12 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c13 = nn.Conv2d(96,96,3, padding=(28,24), dilation=(28,24))
        self.bias_c13 = nn.Linear(self.vs, 96 ) # 330 x 8

        # new
        self.conv_c14 = nn.Conv2d(96,96,3, padding=1)
        self.bias_c14 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c15 = nn.Conv2d(96,96,3, padding=(32,28), dilation=(32,28))
        self.bias_c15 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c16 = nn.Conv2d(96,96,3, padding=(1,32), dilation=(1,32))
        self.bias_c16 = nn.Linear(self.vs, 96 ) # 330 x 8

        # new
        self.conv_c17 = nn.Conv2d(96,96,3, padding=1)
        self.bias_c17 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c18 = nn.Conv2d(96,96,3, padding=1, dilation=1)
        self.bias_c18 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c19 = nn.Conv2d(96,64,3, padding=1, dilation=1)
        self.bias_c19 = nn.Linear(self.vs, 64 ) # 330 x 8

        # decoder convolutions # 150 x 150 x 16
        self.conv_d0 = nn.Conv2d(64,60,3, padding=1)
        self.bias_d0 = nn.Linear(self.vs, 60 ) # 330 x 8

        self.conv_d1 = nn.Conv2d(60,56,3, padding=1)
        self.bias_d1 = nn.Linear(self.vs, 56 ) # 330 x 8

        self.conv_d2 = nn.Conv2d(56,52,3, padding=1)
        self.bias_d2 = nn.Linear(self.vs, 52 ) # 330 x 8

        self.conv_d3 = nn.Conv2d(52,48,3, padding=1)
        self.bias_d3 = nn.Linear(self.vs, 48 ) # 330 x 8
        self.maxpool_d3 = nn.MaxPool2d(3, stride=3)            # 50 x 50 x 48

        self.conv_d4 = nn.Conv2d(48,44,3, padding=1)
        self.bias_d4 = nn.Linear(self.vs, 44 ) # 330 x 8

        self.conv_d5 = nn.Conv2d(44,40,3, padding=1)
        self.bias_d5 = nn.Linear(self.vs, 40 ) # 330 x 8

        self.conv_d6 = nn.Conv2d(40,36,3, padding=1)
        self.bias_d6 = nn.Linear(self.vs, 36 ) # 330 x 8

        self.conv_d7 = nn.Conv2d(36,32,3, padding=1)
        self.bias_d7 = nn.Linear(self.vs, 32 ) # 330 x 8
        self.maxpool_d7 = nn.MaxPool2d(2, stride=2)            # 25 x 25 x 32

        self.conv_d8 = nn.Conv2d(32,28,3, padding=1)
        self.bias_d8 = nn.Linear(self.vs, 28 ) # 330 x 8

        self.conv_d9 = nn.Conv2d(28,24,3, padding=1)
        self.bias_d9 = nn.Linear(self.vs, 24 ) # 330 x 8

        self.conv_d10 = nn.Conv2d(24,20,3, padding=1)
        self.bias_d10 = nn.Linear(self.vs, 20 ) # 330 x 8

        self.conv_d11 = nn.Conv2d(20,16,3, padding=1)
