...
class CNNBiasAll(nn.Module):
    ...
    def __init__(self, n_past_lidars, n_past_steps, n_future_steps):
        ...
        self.conv_c2 = nn.Conv2d(96,96,3, padding=(2,2), dilation=(2,2))
        self.bias_c2 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c3 = nn.Conv2d(96,96,3, padding=(4,4), dilation=(4,4))
        self.bias_c3 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c4 = nn.Conv2d(96,96,3, padding=(8,8), dilation=(8,8))
        self.bias_c4 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c5 = nn.Conv2d(96,96,3, padding=(12,12), dilation=(12,12))
        self.bias_c5 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c6 = nn.Conv2d(96,96,3, padding=(16,16), dilation=(16,16))
        self.bias_c6 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c7 = nn.Conv2d(96,96,3, padding=(20,20), dilation=(20,20))
        self.bias_c7 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c8 = nn.Conv2d(96,96,3, padding=(24,24), dilation=(24,24))
        self.bias_c8 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c9 = nn.Conv2d(96,96,3, padding=(28,28), dilation=(28,28))
        self.bias_c9 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c10 = nn.Conv2d(96,96,3, padding=(32,32), dilation=(32,32))
        self.bias_c10 = nn.Linear(self.vs, 96 ) # 330 x 8

        self.conv_c11 = nn.Conv2d(96,96,3, padding=(36,36), dilation=(36,36))
