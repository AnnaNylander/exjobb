    ...
    with make_carla_client(host, port) as client:
        ...
        for frame in range(0,args.frames):
            ...
            if planner_path is not None:
                ...
                intention, flag = client_util.GetIntention(prev_measurements,
                    prev_intentions, intentions_path)
                # Roll previous measurements to behave like a FIFO queue, then insert pm
                ...
                #Calculate traffic
                traffic, flag = client_util.GetTraffic(prev_measurements,
                    static_values, dynamic_values, prev_traffic, traffic_path)
                print(traffic)
                # Roll previous measurements to behave like a FIFO queue, then insert pm
